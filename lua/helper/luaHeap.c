 ...
 * https://sourceforge.net/p/freertos/code/HEAD/tree/tags/V9.0.0/FreeRTOS/Source/portable/MemMang/heap_4.c
 */
...
/* Assumes 8bit bytes! */
#define LUA_HEAP_BITS_PER_BYTE		( ( size_t ) 8 )

static uint8_t ucHeap[LUA_HEAP_SIZE] __dtcm_noinit_section __aligned(8);


#ifndef LUA_BYTE_ALIGNMENT
#define LUA_BYTE_ALIGNMENT      (sizeof(size_t))
#endif

#define LUA_tBYTE_ALIGNMENT_MASK ( LUA_BYTE_ALIGNMENT - 1 )
...
static const size_t xHeapStructSize	= ( sizeof( BlockLink_t ) + ( ( size_t ) ( LUA_BYTE_ALIGNMENT - 1 ) ) ) & ~( ( size_t ) LUA_tBYTE_ALIGNMENT_MASK );
