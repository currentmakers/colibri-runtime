...
{
    rgb_update();
    io_schedule(&supervisor_update_work, K_MSEC(20));
}

void rgb_updater_initialize()
{
    k_work_init_delayable(&supervisor_update_work, rgb_updater_task);
    io_schedule(&supervisor_update_work, K_MSEC(200));
}
