...
#define is_event_type(EVENT, TYPE) ((EVENT & 0x3FF0000) == TYPE)
#define is_io_event(EVENT) ((EVENT & (1<<26)) == (1<<26))
#define is_user_event(EVENT) ((EVENT & (1<<26)) == 0x0)
#define create_io_event(SLOT, EVENT_TYPE, EVENT_ID) (SLOT<<27 | 1<<26 | EVENT_TYPE<<16 | EVENT_ID)
...
#define COLIBRI_EVENT_TYPE_RGB_SET            0x0E
